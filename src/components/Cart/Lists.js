...
export default function AlignItemsList() {
    ...
    <ListItemText
          ...
          secondary={
            <React.Fragment>
             ...
             <div> {`${content.qty} x ${content.discountedprice} = ${content.discountedprice * content.qty}`}</div>
            </React.Fragment>
          }
        />
    </ListItem>
  ...
  return (
       ...
       <Divider  component="li" className = "MuiDivider-root"/>
